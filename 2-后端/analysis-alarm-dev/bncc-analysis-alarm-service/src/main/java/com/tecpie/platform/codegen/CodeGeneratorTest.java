...
public class CodeGeneratorTest {
    ...
    public static void main(String[] args) {
        ...
        // 微服务项目 - 当项目划分多个子项目时填写
        param.setBaseApiDirOffset("bncc-analysis-alarm-api");
        param.setBaseServiceDirOffset("bncc-analysis-alarm-service");
        // 业务模块生成的基础包路径
        ...
        param.getTableCollection().put("notice", new String[][]{{"t_task_advance_notice"}});
        // 执行代码生成
