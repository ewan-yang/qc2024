...
public interface PowerCutRepeatStatisticsResourceAssembler extends IAssembler<PowerCutRepeatStatistics, PowerCutRepeatStatisticsResource> {

    PowerCutRepeatStatisticsResourceAssembler INSTANCE = Mappers.getMapper(PowerCutRepeatStatisticsResourceAssembler.class);
    ...
    PowerCutRepeatStatisticsResource parse(PowerCutRepeatStatistics entity);

    @AfterMapping
    default void afterMapping(@MappingTarget PowerCutRepeatStatisticsResource resource, PowerCutRepeatStatistics entity) {
        // 自定义映射
