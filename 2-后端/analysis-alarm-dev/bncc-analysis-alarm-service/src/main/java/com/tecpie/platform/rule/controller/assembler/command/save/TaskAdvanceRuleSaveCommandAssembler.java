package com.tecpie.platform.rule.controller.assembler.command.save;
...
public interface TaskAdvanceRuleSaveCommandAssembler extends IAssembler<TaskAdvanceRuleSaveCommand, TaskAdvanceRule> {

  TaskAdvanceRuleSaveCommandAssembler INSTANCE = Mappers.getMapper(TaskAdvanceRuleSaveCommandAssembler.class);
  ...
  TaskAdvanceRule parse(TaskAdvanceRuleSaveCommand command);

  @AfterMapping
  default void afterMapping(@MappingTarget TaskAdvanceRule entity, TaskAdvanceRuleSaveCommand command) {
    // 自定义映射
