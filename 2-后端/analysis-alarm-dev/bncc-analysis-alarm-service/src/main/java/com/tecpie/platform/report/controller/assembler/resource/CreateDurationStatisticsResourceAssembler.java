...
public interface CreateDurationStatisticsResourceAssembler extends IAssembler<CreateDurationStatistics, CreateDurationStatisticsResource> {

    CreateDurationStatisticsResourceAssembler INSTANCE = Mappers.getMapper(CreateDurationStatisticsResourceAssembler.class);
    ...
    CreateDurationStatisticsResource parse(CreateDurationStatistics entity);

    @AfterMapping
    default void afterMapping(@MappingTarget CreateDurationStatisticsResource resource, CreateDurationStatistics entity) {
        // 自定义映射
