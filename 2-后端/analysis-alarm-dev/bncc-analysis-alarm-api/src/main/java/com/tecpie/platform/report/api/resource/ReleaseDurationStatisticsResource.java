 ...
 * @since 2023-08-03
 */
@Schema(description = "下发时长统计分析 数据响应结果")
@Getter
@Setter
public class ReleaseDurationStatisticsResource implements Serializable {
     ...
     * 派发负责方
     */
    @Schema(description = "派发负责方")
    @ExcelProperty(value = "派发方")
