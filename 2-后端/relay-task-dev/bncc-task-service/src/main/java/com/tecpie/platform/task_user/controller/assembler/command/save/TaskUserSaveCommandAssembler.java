...
public interface TaskUserSaveCommandAssembler extends IAssembler<TaskUserSaveCommand, TaskUser> {

  TaskUserSaveCommandAssembler INSTANCE = Mappers.getMapper(TaskUserSaveCommandAssembler.class);
  ...
  TaskUser parse(TaskUserSaveCommand command);

  @AfterMapping
  default void afterMapping(@MappingTarget TaskUser entity, TaskUserSaveCommand command) {
    // 自定义映射
