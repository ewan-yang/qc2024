package com.tecpie.platform.seq.controller.assembler.command.update;
...
public interface SeqGenUpdateCommandAssembler extends IAssembler<SeqGenUpdateCommand, SeqGen> {

    SeqGenUpdateCommandAssembler INSTANCE = Mappers.getMapper(SeqGenUpdateCommandAssembler.class);
    ...
    SeqGen parse(SeqGenUpdateCommand command);

    @AfterMapping
    default void afterMapping(@MappingTarget SeqGen entity, SeqGenUpdateCommand command) {
        // 自定义映射
