...
public interface TaskUserResourceAssembler extends IAssembler<TaskUser, TaskUserResource> {

  TaskUserResourceAssembler INSTANCE = Mappers.getMapper(TaskUserResourceAssembler.class);

  /**
   * 映射方法
   *
   * @param entity
   * @return TaskUserResource
   */
  @Override
  @Mappings({
    @Mapping(target = "remark", source = "remark")
  })
  TaskUserResource parse(TaskUser entity);

  @AfterMapping
  default void afterMapping(@MappingTarget TaskUserResource resource, TaskUser entity) {
    // 自定义映射
