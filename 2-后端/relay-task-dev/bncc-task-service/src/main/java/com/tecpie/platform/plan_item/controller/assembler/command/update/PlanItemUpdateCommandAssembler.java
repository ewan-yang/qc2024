package com.tecpie.platform.plan_item.controller.assembler.command.update;
...
public interface PlanItemUpdateCommandAssembler extends IAssembler<PlanItemUpdateCommand, PlanItem> {

    PlanItemUpdateCommandAssembler INSTANCE = Mappers.getMapper(PlanItemUpdateCommandAssembler.class);
    ...
    PlanItem parse(PlanItemUpdateCommand command);

    @AfterMapping
    default void afterMapping(@MappingTarget PlanItem entity, PlanItemUpdateCommand command) {
        // 自定义映射
