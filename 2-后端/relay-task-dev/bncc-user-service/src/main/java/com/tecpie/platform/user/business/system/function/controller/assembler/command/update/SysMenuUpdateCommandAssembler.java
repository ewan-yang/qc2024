...
public interface SysMenuUpdateCommandAssembler extends IAssembler<SysMenuUpdateCommand, SysMenu> {

  SysMenuUpdateCommandAssembler INSTANCE = Mappers.getMapper(SysMenuUpdateCommandAssembler.class);
  ...
  SysMenu parse(SysMenuUpdateCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysMenu entity, SysMenuUpdateCommand command) {
    // 自定义映射
