...
public interface SysRoleResourceAssembler extends IAssembler<SysRole, SysRoleResource> {

  SysRoleResourceAssembler INSTANCE = Mappers.getMapper(SysRoleResourceAssembler.class);
  ...
  SysRoleResource parse(SysRole entity);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysRoleResource resource, SysRole entity) {
    // 自定义映射
