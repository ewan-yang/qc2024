...
public interface SysPermissionResourceAssembler extends IAssembler<SysPermission, SysPermissionResource> {

  SysPermissionResourceAssembler INSTANCE = Mappers.getMapper(SysPermissionResourceAssembler.class);
  ...
  SysPermissionResource parse(SysPermission entity);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysPermissionResource resource, SysPermission entity) {
    // 自定义映射
