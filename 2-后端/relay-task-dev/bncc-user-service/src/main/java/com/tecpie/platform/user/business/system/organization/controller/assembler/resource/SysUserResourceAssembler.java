...
public interface SysUserResourceAssembler extends IAssembler<SysUser, SysUserResource> {

  SysUserResourceAssembler INSTANCE = Mappers.getMapper(SysUserResourceAssembler.class);
  ...
  SysUserResource parse(SysUser entity);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysUserResource resource, SysUser entity) {
    // 自定义映射
