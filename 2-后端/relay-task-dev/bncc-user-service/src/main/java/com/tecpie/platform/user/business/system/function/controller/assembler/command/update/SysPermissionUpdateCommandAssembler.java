...
public interface SysPermissionUpdateCommandAssembler extends IAssembler<SysPermissionUpdateCommand, SysPermission> {

  SysPermissionUpdateCommandAssembler INSTANCE = Mappers.getMapper(SysPermissionUpdateCommandAssembler.class);
  ...
  SysPermission parse(SysPermissionUpdateCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysPermission entity, SysPermissionUpdateCommand command) {
    // 自定义映射
