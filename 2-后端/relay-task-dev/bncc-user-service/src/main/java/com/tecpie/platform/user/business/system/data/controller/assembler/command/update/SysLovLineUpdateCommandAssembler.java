...
public interface SysLovLineUpdateCommandAssembler extends IAssembler<SysLovLineUpdateCommand, SysLovLine> {

  SysLovLineUpdateCommandAssembler INSTANCE = Mappers.getMapper(SysLovLineUpdateCommandAssembler.class);
  ...
  SysLovLine parse(SysLovLineUpdateCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysLovLine entity, SysLovLineUpdateCommand command) {
    // 自定义映射
