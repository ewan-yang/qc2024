package com.tecpie.platform.user.business.user_message.controller.assembler.command.save;
...
public interface UserMessageSaveCommandAssembler extends IAssembler<UserMessageSaveCommand, UserMessage> {

  UserMessageSaveCommandAssembler INSTANCE = Mappers.getMapper(UserMessageSaveCommandAssembler.class);
  ...
  UserMessage parse(UserMessageSaveCommand command);

  @AfterMapping
  default void afterMapping(@MappingTarget UserMessage entity, UserMessageSaveCommand command) {
    // 自定义映射
