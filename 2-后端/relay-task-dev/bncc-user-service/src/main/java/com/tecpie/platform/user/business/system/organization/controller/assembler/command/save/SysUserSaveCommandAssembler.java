...
public interface SysUserSaveCommandAssembler extends IAssembler<SysUserSaveCommand, SysUser> {

  SysUserSaveCommandAssembler INSTANCE = Mappers.getMapper(SysUserSaveCommandAssembler.class);
  ...
  SysUser parse(SysUserSaveCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysUser entity, SysUserSaveCommand command) {
    // 自定义映射
