...
public interface SysMenuSaveCommandAssembler extends IAssembler<SysMenuSaveCommand, SysMenu> {

  SysMenuSaveCommandAssembler INSTANCE = Mappers.getMapper(SysMenuSaveCommandAssembler.class);
  ...
  SysMenu parse(SysMenuSaveCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysMenu entity, SysMenuSaveCommand command) {
    // 自定义映射
