...
public interface SysPermissionSaveCommandAssembler extends IAssembler<SysPermissionSaveCommand, SysPermission> {

  SysPermissionSaveCommandAssembler INSTANCE = Mappers.getMapper(SysPermissionSaveCommandAssembler.class);
  ...
  SysPermission parse(SysPermissionSaveCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysPermission entity, SysPermissionSaveCommand command) {
    // 自定义映射
