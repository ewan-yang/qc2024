...
public interface SysResourceUpdateCommandAssembler extends IAssembler<SysResourceUpdateCommand, SysResource> {

  SysResourceUpdateCommandAssembler INSTANCE = Mappers.getMapper(SysResourceUpdateCommandAssembler.class);
  ...
  SysResource parse(SysResourceUpdateCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysResource entity, SysResourceUpdateCommand command) {
    // 自定义映射
