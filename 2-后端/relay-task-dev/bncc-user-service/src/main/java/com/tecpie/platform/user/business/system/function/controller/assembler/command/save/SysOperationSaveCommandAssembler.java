...
public interface SysOperationSaveCommandAssembler extends IAssembler<SysOperationSaveCommand, SysOperation> {

  SysOperationSaveCommandAssembler INSTANCE = Mappers.getMapper(SysOperationSaveCommandAssembler.class);
  ...
  SysOperation parse(SysOperationSaveCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysOperation entity, SysOperationSaveCommand command) {
    // 自定义映射
