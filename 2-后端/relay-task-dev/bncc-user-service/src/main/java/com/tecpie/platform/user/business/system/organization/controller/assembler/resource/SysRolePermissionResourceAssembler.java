...
public interface SysRolePermissionResourceAssembler extends IAssembler<SysRolePermission, SysRolePermissionResource> {

  SysRolePermissionResourceAssembler INSTANCE = Mappers.getMapper(SysRolePermissionResourceAssembler.class);
   ...
   *
   * @param entity entity
   * @return SysRolePermissionResource
   */
  @Override
  @Mapping(target = "remark", source = "remark")
  SysRolePermissionResource parse(SysRolePermission entity);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysRolePermissionResource resource, SysRolePermission entity) {
    // 自定义映射
