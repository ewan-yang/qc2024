...
public interface SysUserUnitSaveCommandAssembler extends IAssembler<SysUserUnitSaveCommand, SysUserUnit> {

  SysUserUnitSaveCommandAssembler INSTANCE = Mappers.getMapper(SysUserUnitSaveCommandAssembler.class);
  ...
  SysUserUnit parse(SysUserUnitSaveCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysUserUnit entity, SysUserUnitSaveCommand command) {
    // 自定义映射
