...
public interface SysUserRoleSaveCommandAssembler extends IAssembler<SysUserRoleSaveCommand, SysUserRole> {

  SysUserRoleSaveCommandAssembler INSTANCE = Mappers.getMapper(SysUserRoleSaveCommandAssembler.class);
  ...
  SysUserRole parse(SysUserRoleSaveCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysUserRole entity, SysUserRoleSaveCommand command) {
    // 自定义映射
