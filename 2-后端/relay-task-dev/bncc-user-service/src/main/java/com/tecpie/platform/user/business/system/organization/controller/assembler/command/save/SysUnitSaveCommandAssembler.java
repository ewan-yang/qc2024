...
public interface SysUnitSaveCommandAssembler extends IAssembler<SysUnitSaveCommand, SysUnit> {

  SysUnitSaveCommandAssembler INSTANCE = Mappers.getMapper(SysUnitSaveCommandAssembler.class);
  ...
  SysUnit parse(SysUnitSaveCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysUnit entity, SysUnitSaveCommand command) {
    // 自定义映射
