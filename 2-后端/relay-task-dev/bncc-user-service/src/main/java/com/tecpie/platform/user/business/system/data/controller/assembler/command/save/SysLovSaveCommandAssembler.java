...
public interface SysLovSaveCommandAssembler extends IAssembler<SysLovSaveCommand, SysLov> {

  SysLovSaveCommandAssembler INSTANCE = Mappers.getMapper(SysLovSaveCommandAssembler.class);
  ...
  SysLov parse(SysLovSaveCommand command);
   ...
   */
  @AfterMapping
  default void afterMapping(@MappingTarget SysLov entity, SysLovSaveCommand command) {
    // 自定义映射
